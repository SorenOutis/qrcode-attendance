...
function submitComment() {
    ...
    form.post(commentsRoutes.store.url(), {
        preserveScroll: true,
        onSuccess: () => {
            form.reset();
...
onMounted(() => {
    if (heroRef.value) {
        gsap.from(heroRef.value.querySelectorAll('[data-hero-animate]'), {
            opacity: 0,
            y: 32,
            duration: 0.9,
            ease: 'power3.out',
    ...
    >
        ...
        >
            ...
            >
                ...
                >
                    <h1 data-hero-animate class="mb-1 text-xl font-semibold">
                        QR Attendance for your classroom
                    </h1>
                    <p
                        data-hero-animate
                        class="mb-4 text-[#706f6c] dark:text-[#A1A09A]"
                    >
                        Scan once, track all. Simple QR-based attendance with
                        smart schedules and real-time status.
                    </p>
                    <ul
                        data-hero-animate
                        class="mb-4 flex flex-col space-y-1.5 text-[13px] lg:mb-6"
                    >
                        <li
                    ...
                    <div
                        data-hero-animate
                        class="mt-4 flex flex-wrap gap-3 text-sm leading-normal"
                    >
                        <Button
                            v-if="$page.props.auth.user"
                            as-child
        ...
        <section
            ref="formRef"
            class="mt-10 w-full max-w-[335px] rounded-xl border border-[#19140035] bg-white/90 p-6 text-[13px] leading-[20px] shadow-sm lg:max-w-4xl dark:border-[#3E3E3A] dark:bg-[#161615] dark:text-[#F9FAFB]"
        >
            <div data-hero-animate>
                <h2 class="text-base font-semibold text-[#111827] dark:text-[#F9FAFB]">
                    Comments & suggestions
                </h2>
                <p class="mt-1 text-xs text-[#706f6c] dark:text-[#A1A09A]">
                    Tell us what you think about this attendance system. Your
            ...
            <form class="mt-4 space-y-3" @submit.prevent="submitComment">
                <div class="grid gap-3 md:grid-cols-2">
                    <div class="space-y-1.5">
                        <label class="text-xs font-medium text-[#111827] dark:text-[#E5E7EB]">
                            Name
                        </label>
                    ...
                    <div class="space-y-1.5">
                        ...
                        <p class="text-[11px] text-muted-foreground">
                            Used only if we need to follow up.
                        </p>
                    </div>
                </div>
                ...
                <div class="space-y-1.5">
                    ...
                    <textarea
                        ...
                        rows="4"
                        class="w-full rounded-md border border-[#19140035] bg-white px-3 py-2 text-[13px] leading-relaxed shadow-sm outline-none focus-visible:border-[#f53003] focus-visible:ring-2 focus-visible:ring-[#f53003]/20 dark:border-[#3E3E3A] dark:bg-[#161615]"
                ...
                <div class="mt-2 flex items-center justify-between gap-3">
                    ...
                    >
                        Thank you for your feedback! It will show up on the
        ...
        <Dialog v-model:open="rateModalOpen">
            <DialogContent class="max-w-md">
                ...
                <form class="space-y-3" @submit.prevent="submitRating">
                    <div class="grid gap-3 md:grid-cols-2">
                        <div class="space-y-1.5">
                            <label class="text-xs font-medium text-[#111827] dark:text-[#E5E7EB]">
                                Name
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="flex items-center gap-1">
                            ...
                            >
                                <span
                                    class="text-2xl"
                                    :class="i <= ratingForm.score ? 'text-yellow-400' : 'text-muted-foreground/40'"
                                >
                                    ★
                                </span>
                            </button>
                    ...
                    <div class="space-y-1.5">
                        ...
                        <textarea
                            ...
                            rows="3"
                            class="w-full rounded-md border border-[#19140035] bg-white px-3 py-2 text-[13px] leading-relaxed shadow-sm outline-none focus-visible:border-[#f53003] focus-visible:ring-2 focus-visible:ring-[#f53003]/20 dark:border-[#3E3E3A] dark:bg-[#161615]"
                            placeholder="Share anything specific you liked or want improved…"
                        />
                        <p
                            v-if="ratingForm.errors.message"
                            class="text-xs text-red-500 dark:text-red-400"
                        >
                            {{ ratingForm.errors.message }}
                        </p>
                    </div>

                    <DialogFooter class="mt-3 flex justify-end gap-2">
                        <Button
                            type="button"
                            variant="outline"
                            size="sm"
